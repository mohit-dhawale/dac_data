...
public class LoginServlet extends HttpServlet {
	...
	public LoginServlet(String mesg) {
		System.out.println("in arged  ctor " + getServletConfig());// null
	}

	public void init() throws ServletException {
		try {
			ServletConfig config = getServletConfig();
			System.out.println("in def ctor " + config);// not-null
			String url = config.getInitParameter("db_url");
			String name = config.getInitParameter("user_name");
			String pwd = config.getInitParameter("password");

			// create dao instance
			userDao = new UserDaoImpl(url, name, pwd);
			candidateDao = new CandidateDaoImpl(url, name, pwd);
		} catch (Exception e) {
